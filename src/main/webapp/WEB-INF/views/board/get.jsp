...
<body>
	<div class="container" role="main">
		<h2>content view</h2>
			...
			<div class="mb-3">
				<label>제목</label>
				<input name="title" class="form-control" readonly="readonly" value='<c:out value="${pageInfo.title}"/>' >
			</div>		
			<div class="mb-3">
				<label>내용</label>
				<textarea rows="3" class="form-control" name="content" readonly="readonly"><c:out value="${pageInfo.content}"/></textarea>
			</div>	
			<div class="mb-3">
				<label>작성자</label>
			...
			<div>
				...
				<a class="btn" id="modify_btn" style="border: 1px solid #ddd;">수정</a>
			</div>
